...
- (NSUInteger)indexOfObjectWithPredicate:(NSPredicate *)predicate {
    ...
    query.and_query(RLMPredicateToQuery(predicate, _info->rlmObjectSchema, _realm.schema));
...
- (RLMResults *)objectsWithPredicate:(NSPredicate *)predicate {
    return translateErrors([&] {
        ...
        auto query = RLMPredicateToQuery(predicate, _info->rlmObjectSchema, _realm.schema);
